...
public class Grammar {
	...
	Hashtable<String, ArrayList< RHS> > grammar;
	
	HashSet<String> terminals = null;
	
	HashSet<String> preTerminals = null;
	
	HashSet<String> nonTerminals = null;
	 ...
	 * */
	Hashtable<String, ArrayList<String>> rhs2lhs = null;
	...
	public void printGrammarInfo() {
		...
		for (String lhs : grammar.keySet()) {
			//System.out.println("3333"+lhs);
			for (RHS rhs : grammar.get(lhs)) {
				rhs.printProduction(lhs);
				//System.out.println("lalala"+rhs.second());
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		g.printGrammarInfo();
		//while(grammar.terminals.contains()==false)
	}
}
